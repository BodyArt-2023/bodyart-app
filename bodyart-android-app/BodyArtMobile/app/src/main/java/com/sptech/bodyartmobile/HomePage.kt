...
class HomePage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nomeUser = intent.getStringExtra("nomeUser")
    ...
    fun validarAutenticacao() {
        ...
        Toast.makeText(baseContext, getString(R.string.msg_boas_vindas, nome), Toast.LENGTH_SHORT)
            .show()
    ...
    fun vaiParaConfig(view: View) {
        val telaConfig = Intent(applicationContext, Configuracoes::class.java)
        telaConfig.putExtra("id", idUser)
        telaConfig.putExtra("nome", nomeUser)
